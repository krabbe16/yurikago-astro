...
<p class="text-center text-muted fst-italic">before</p>

![](@/assets/images/post/ca865528692d-20220630.png)

<p class="text-center text-muted fst-italic">after(なぜか背景が黒くなる)</p>
...
<p class="text-center text-muted fst-italic">左：基点ブランチ 右：Renovateブランチ</p>
